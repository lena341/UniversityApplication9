...
It performes CRUD operations in an Azure SQL Database that runs on an Azure Server. I connected the the Azure SQL Database with a connection string that exists in appsetting.json. You can add your own connection string.
